...
3. **Valid far longer than a track.** A move near the end of a long track
   re-requests a URL minted when the track began. Music Assistant signs for 12 hours.

Music Assistant pins all three in `tests/test_security.py` for that reason.
