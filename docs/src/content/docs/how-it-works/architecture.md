...
Ampere sits between two APIs it does not control: Amazon's Music, Radio, and
...
<svg viewBox="0 0 720 232" xmlns="http://www.w3.org/2000/svg" role="img" aria-labeledby="flow-title">
  ...
  <text class="label" x="450" y="60" text-anchor="middle">Ampere</text>
...
```
https://ampere.example.com/stream/<song-id>/<expires>/<signature>
https://ampere.example.com/art/<cover-id>/<expires>/<signature>
```
