---
title: What this is
description: What Music Assistant does, what it cannot do, and how long setup actually takes.
sidebar:
  order: 1
---

Music Assistant is an Alexa **Music Skill**, not a custom skill. It sits between Amazon
...
`music assistant` there is an alias you choose. Substitute yours everywhere in these
pages.
