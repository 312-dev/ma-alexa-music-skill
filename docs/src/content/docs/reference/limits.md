...
description: What Music Assistant does not do, stated plainly, including the things with no known cause.
---
...
Music Assistant works around it rather than fixing it, because the cause is on Amazon's
