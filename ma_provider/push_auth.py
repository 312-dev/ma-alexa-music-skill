...
Music Assistant's REST calls authenticate with a cookie jar. The push stream does not:
...
`openid.oa2.access_token`. Walking those pages is what mints it. Music Assistant never
