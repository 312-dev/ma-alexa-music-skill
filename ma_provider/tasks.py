...
The crawl blocks, so it runs on Music Assistant's own thread pool rather than the
...
UPLOAD_TASK_ID = "ma_alexa_catalog_upload"
SYNC_TASK_ID = "ma_alexa_catalog_sync"
BINDING_TASK_ID = "ma_alexa_binding_keepalive"
...
class MaAlexaTasks:
    """Music Assistant's long-running work, as MA sees it."""
    ...
    def start_upload(self, *, cycle_after: bool = False) -> Any:
        ...
        return self.mass.tasks.run_background_task(
            name="Music Assistant: upload library to Amazon",
    ...
    def register_sync(self) -> None:
        ...
        self.mass.tasks.register_scheduled_task(
            ...
            name="Music Assistant: sync library to Amazon",
    ...
    def register_binding_keepalive(self) -> None:
        ...
        self.mass.tasks.register_scheduled_task(
            ...
            name="Music Assistant: keep the Alexa skill bound",
